  ...
  return (
    <Box
      ...
      sx={{
        ...
        pb: { xs: 6, md: 10 },
        overflow: 'hidden',
        backgroundImage: 'linear-gradient(to bottom, rgba(255, 255, 255, 0.75) 0%, rgba(244, 248, 246, 0.95) 100%), url("/hero_sprout_bg.jpg")',
            ...
            <Box sx={{ pr: { lg: 2 } }}>
              ...
              <Button
                ...
                sx={{
                  ...
                  py: 1.4,
                  textTransform: 'none',
                  boxShadow: '0 6px 20px rgba(0, 135, 81, 0.35)',
                  '&:hover': {
                    bgcolor: '#006e42',
                  },
                }}
              ...
              <Box component="form" onSubmit={handleSubmit} sx={{ p: 2.5 }}>
                <Stack spacing={1.6}>
                  ...
                  <Stack direction="row" spacing={0.8} alignItems="center" justifyContent="center" sx={{ pt: 0.5 }}>
                    <ShieldOutlinedIcon sx={{ color: '#008751', fontSize: 16 }} />
