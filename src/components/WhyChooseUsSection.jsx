        ...
        <Grid container spacing={{ xs: 4, md: 6 }} alignItems="center">
            ...
            >
              ...
              <Box
                sx={{
                  position: 'absolute',
                  inset: 0,
                  background: 'linear-gradient(to top, rgba(6, 78, 59, 0.85) 0%, rgba(0, 0, 0, 0.2) 60%, transparent 100%)',
                  display: 'flex',
                  alignItems: 'flex-end',
                  p: { xs: 3, md: 4 },
                }}
          ...
          <Grid item xs={12} md={6.5}>
            <Box sx={{ pl: { md: 2 } }}>
              ...
              >
                At <strong style={{ color: '#064e3b' }}>SKV Solution</strong>, we specialize in helping businesses achieve <strong style={{ color: '#008751' }}>EcoVadis certification</strong> with expert guidance, personalized support and a result-driven approach.
              </Typography>
              ...
              <Stack spacing={2}>
                {points.map((point, idx) => (
                  <Stack direction="row" spacing={1.5} alignItems="center" key={idx}>
                    <CheckCircleIcon sx={{ color: '#008751', fontSize: 22 }} />
                    <Typography
                      variant="body1"
                      sx={{
                        fontWeight: 700,
