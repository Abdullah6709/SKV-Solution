          ...
          >
            {navItems.map((item, index) => (
              <Button
                ...
                sx={{
                  color: index === 0 ? '#00965e' : '#334155',
                  fontWeight: index === 0 ? 800 : 600,
                  fontSize: '0.9rem',
                  px: 1.8,
                  py: 1,
                  position: 'relative',
                  borderBottom: index === 0 ? '2px solid #00965e' : 'none',
                  borderRadius: index === 0 ? '0' : '6px',
                  '&:hover': {
                    bgcolor: 'rgba(0, 150, 94, 0.06)',
                    color: '#00965e',
                  },
                }}
              >
          ...
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            <Button
              ...
              sx={{
                ...
                '&:hover': {
                  bgcolor: '#006e42',
                  boxShadow: '0 6px 18px rgba(0, 135, 81, 0.4)',
                },
              }}
            >
              +91 8800320483
            ...
            >
              <MenuIcon sx={{ fontSize: 28, color: '#064e3b' }} />
            </IconButton>
          </Stack>
        </Toolbar>
      </Container>
          ...
          {navItems.map((item) => (
            <ListItem
              ...
              sx={{
                ...
                mb: 0.8,
                py: 1.2,
                '&:hover': { bgcolor: 'rgba(0, 150, 94, 0.08)' }
              }}
            >
              <ListItemText
                primary={item.label}
          ...
          <Stack spacing={1.5}>
            ...
            <Button
              ...
              sx={{
                ...
                borderRadius: '8px',
                textTransform: 'none',
                '&:hover': { borderColor: '#006e42', bgcolor: 'rgba(0,135,81,0.06)' }
              }}
            >
              enquiry@skvs.in
            </Button>
