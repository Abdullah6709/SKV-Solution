    ...
    >
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', mb: 8, maxWidth: 800, mx: 'auto' }}>
          <Chip
            icon={<HelpOutlineIcon sx={{ color: '#064e3b !important' }} />}
          ...
          {faqs.map((faq, index) => (
            <Accordion
              ...
              sx={{
                ...
                boxShadow: expanded === index ? '0 10px 25px rgba(6, 78, 59, 0.08)' : 'none',
                '&:before': { display: 'none' },
            ...
            >
              <AccordionSummary
                ...
                sx={{
                  py: 1.5,
                  px: 3,
                  bgcolor: expanded === index ? 'rgba(5, 150, 105, 0.04)' : '#ffffff',
                  borderRadius: '16px',
                }}
              >
                <Typography
                  ...
                  sx={{
                    ...
                    color: expanded === index ? '#064e3b' : '#0f172a',
                  }}
                >
                  {faq.question}
                </Typography>
