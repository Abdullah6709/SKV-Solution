    ...
    >
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', mb: 8, maxWidth: 800, mx: 'auto' }}>
          <Chip
            icon={<VerifiedIcon sx={{ color: '#064e3b !important' }} />}
        ...
        <Grid container spacing={5}>
          ...
          <Grid item xs={12} md={5}>
            <Stack spacing={3}>
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 800, color: '#34d399', mb: 2 }}>
                  SKV Solutions Pvt Ltd
                </Typography>

                <Stack spacing={2}>
                  <Stack direction="row" spacing={1.5} alignItems="flex-start">
                    <LocationOnIcon sx={{ color: '#34d399', mt: 0.3 }} />
                    <Box>
                  ...
                  <Stack direction="row" spacing={1.5} alignItems="center">
                    <AccessTimeIcon sx={{ color: '#34d399' }} />
                    <Typography variant="body2" sx={{ color: '#cbd5e1', fontSize: '0.875rem' }}>
